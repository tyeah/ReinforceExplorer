...
### create the third bars as the second player -- lin shao
bar3 = bar.convert()
bar3.fill((200,100,100))
...
while True:
    ...
    screen.blit(bar3,(bar3_x,bar3_y))
...
#AI of the computer.
    ...
    if bar3_y >= 420. : bar3_y = 420.
    elif bar3_y <= 10. : bar3_y = 10.
...
#since i don't know anything about collision, ball hitting bars goes like this.
    if circle_x <= bar1_x + 10.:
        if circle_y >= bar1_y - 7.5 and circle_y <= bar1_y + 42.5:
            circle_x = 20.
            speed_x = -speed_x
        if circle_y >= bar3_y - 7.5 and circle_y <= bar3_y + 42.5:
            circle_x = 20.
            speed_x = -speed_x
